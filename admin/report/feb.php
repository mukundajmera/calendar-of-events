...
$qry="select * from eventcalendar where (eventdate>'2014-02-01' AND eventdate<'2014-02-29') ORDER BY eventdate ASC";
$val=mysql_query($qry);

?>
<center> <h2 style="color:blue; text-decoration:underline;">February 2014 events</h2>
