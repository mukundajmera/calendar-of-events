...
$qry="select * from eventcalendar where (eventdate>'2014-04-01' AND eventdate<'2014-04-31') ORDER BY eventdate ASC";
$val=mysql_query($qry);

?>
<center> <h2 style="color:blue; text-decoration:underline;">april 2014 events</h2>
