...
$qry="select * from eventcalendar where (eventdate>'2014-01-01' AND eventdate<'2014-01-31') ORDER BY eventdate ASC";
$val=mysql_query($qry);

?>
<center> <h2 style="color:blue; text-decoration:underline;">January 2014 events</h2>
