...
$qry="select * from eventcalendar where (eventdate>'2014-09-01' AND eventdate<'2014-09-31') ORDER BY eventdate ASC";
$val=mysql_query($qry);

?>
<center> <h2 style="color:blue; text-decoration:underline;">September 2013 events</h2>
